...
task("join-dao", "Join the Data DAO as a member")
    ...
    .setAction(async ({nftcontract, daocontract}, { ethers }) => {
        ...
        const DataDAOBountyContract = new ethers.Contract(daocontract, DataDAOBounty.interface, signer)

        await DataDAOBountyContract.joinDAO({
            gasLimit: 1000000000,
            maxPriorityFeePerGas: priorityFee
        })
    ...
    // npx hardhat join-dao --nftcontract 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266 --daocontract 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266 --network hyperspace
