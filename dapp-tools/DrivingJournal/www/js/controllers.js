...
.controller('OptionsCtrl', function($scope, $ionicLoading , CloudService , $http, $state, ModalService, $interval, LocalFiles, $timeout) {
   ...
   // save and save as starts here
            ...
            request(messages, function(result){
                    ...
                    message.type="POST";
                    message.format = 'json';
                    message.data={action:"savecurrentfile",fname:fname,data:val1,appname:"Driving Journal"};
...
.controller('ListFilesWebCtrl', function($scope, $timeout , $ionicLoading , $interval, $state, CloudService ,$ionicHistory, $ionicActionSheet){
            ...
            CloudService.checkLogin().then(function(response){
                   ...
                   //logged in
                   var files = new Array();
                   var message ={action:"listdir",appname:"Driving Journal"};
            ...
            CloudService.checkLogin().then(function(response){
               ...
               var message ={action:"deletefile",appname:"Driving Journal",fname:file};
            ...
            var message ={action:"getfile",appname:"Driving Journal",fname:file};
...
var data={action:"logout",appname:"Driving Journal"};
...
.controller('PurchaseCtrl', function($scope, Items ,CloudService, $timeout ,$ionicLoading, $interval, ModalService, $ionicActionSheet) {
   ...
   //alert(JSON.stringify($scope.items));
    ...
    if(item == "save"){
        ...
        for(i in products){
        if(products[i].Id == "2016dj10share") continue;
    ...
    $scope.purchasePDF = function(id){
        ...
        if(id == "2016dj10Pdf" || id == "2016dj25Pdf" || id == "2016dj50Pdf" || id == "2016dj100Pdf"){
            for(var i=0;i<4;i++){
        ...
        else if(id == "2016dj10share"){
            if(products[4].Purchase == "Yes")
            return;
        }
        else if(id == "2015djCloud"){
        ...
        else if(id == "2015djSavePrintEmail"){
        ...
        else if(id == "2016dj500SavePrintEmail"){
        ...
        else if(id == "2016dj1000SavePrintEmail"){
...
.controller('LocalSaveWebCtrl', function($scope, CloudService, $ionicLoading){
            ...
            var message ={action:"getfile",appname:"Driving Journal",fname:filename};
