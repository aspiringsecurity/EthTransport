# Snap for Transport DAO

We are extending the template on how to develop a snap with TypeScript for the Transport DAO project. For detailed instructions, see [the MetaMask documentation](https://docs.metamask.io/guide/snaps.html#serving-a-snap-to-your-local-environment).
