# DataDAO for Transport Monitoring and Road Incident Management
**A FVM compatible deal bounty contract that demonstrates one way of implementing a Data DAO on Filecoin for Transport Monitoring and Road Incident Management.**

Lists data bounties by insurance organizations and pollution check departments to claim, and pays out the bounty upon the deal proven to be made with the builtin filecoin builtin market.
